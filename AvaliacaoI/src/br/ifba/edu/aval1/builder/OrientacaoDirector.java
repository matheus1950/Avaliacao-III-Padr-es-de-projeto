...
public class OrientacaoDirector {
	...
	public void makePercurso01() {
		...
		this.builder.addPrisma(new Prisma(38, new PontoGeografico(-12.99641, -38.47240, 0.0)));
		this.builder.addPrisma(new Prisma(39, new PontoGeografico(-12.99684, -38.47436, 0.0)));
		this.builder.addPrisma(new Prisma(39, new PontoGeografico(-12.99684, -38.47436, 0.0)));
