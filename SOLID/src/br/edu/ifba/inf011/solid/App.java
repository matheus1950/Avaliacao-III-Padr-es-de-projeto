...
public class App {
	...
	public void run3(CalculadoraRegras calculadora) throws DomainException{
		...
		System.out.println("*******************");
		calculadora.aumentarSalario(estagiario, new BigDecimal("0.10"));
		System.out.println(estagiario);
		System.out.println("*******************");
		...
		System.out.println("****************************");
		promotor.promover(terceirizado);
		System.out.println("*******************");
		System.out.println(terceirizado);
