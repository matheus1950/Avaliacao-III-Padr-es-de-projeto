...
public class JDrawingBridgeGUI2 extends JFrame {

    private JPanel drawingPanel;
    private JRadioButton solidButton, dashedButton, dottedButton;
    private AdvancedDrawShape drawShape = new AdvancedDrawShape(new SolidPen());

    public JDrawingBridgeGUI2() {
    ...
    private void drawHouseAndSun(Graphics g) {
        ...
        this.drawShape.stickFigure(g, 400, 210, 10);
        this.drawShape.stickFigure(g, 350, 210, 10);
        this.drawShape.stickFigure(g, 425, 230, 5);

        
        this.drawShape.star(g, 400, 50, 10);
        this.drawShape.star(g, 400, 150, 10);
        this.drawShape.star(g, 350, 80, 10);
        this.drawShape.star(g, 450, 80, 10);
        this.drawShape.star(g, 425, 95, 10);
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(JDrawingBridgeGUI2::new);
    }
}